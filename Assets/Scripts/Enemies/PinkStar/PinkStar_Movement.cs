...
public class PinkStar_Movement : MonoBehaviour
{
    ...
    private void CheckGround()
    {
        ...
        {
            PlayAnimation("PinkStar_Ground", 0.1f);
        }
    }
    ...
    private void UpdateAnimations()
    {
        ...
        if (isGrounded)
        {
            if (Mathf.Abs(rb.linearVelocity.x) > 0.1f)
                newState = "PinkStar_Run";
            else
                newState = "PinkStar_Idle";
        }
        else
        {
            if (rb.linearVelocity.y > 0.1f)
                newState = "PinkStar_Jump";
            else
                newState = "PinkStar_Fall";
        }
    ...
    public bool IsDead()
    {
        return currentAnimState == "PinkStar_DeadHit" || currentAnimState == "PinkStar_DeadGround";
    }
}
